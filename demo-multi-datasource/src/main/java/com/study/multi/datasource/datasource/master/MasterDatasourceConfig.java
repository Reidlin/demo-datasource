package com.study.multi.datasource.datasource.master;
...
@Configuration
@MapperScan(basePackages = "com.study.multi.datasource.mapper.master", sqlSessionTemplateRef = "masterSqlSessionTemplate")
public class MasterDatasourceConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("masterDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setTypeAliasesPackage("com.study.multi.datasource.entity.master");
