package com.study.aop.multi.datasource.datasource.slave;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.study.aop.multi.datasource.mapper.slave", sqlSessionTemplateRef = "slaveSqlSessionTemplate")
public class SlaveDatasourceConfig {
    ...
    public SqlSessionFactory slaveSqlSessionFactory(@Qualifier("slaveDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setTypeAliasesPackage("com.study.aop.multi.datasource.entity.slave");
